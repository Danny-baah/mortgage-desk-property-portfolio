  ...
  return (
    <section className="pt-20 lg:pt-32 pb-6 lg:pb-12 bg-white relative px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      */}
      ...
      {/* Main container background remains Dominant Green */}
      <div className="max-w-7xl mx-auto relative rounded-3xl overflow-hidden shadow-2xl bg-[#b5d334]">
        {/* Background Decorative Elements optimized for the green theme */}
        <div className="absolute top-0 right-0 -mt-20 -mr-20 w-80 h-80 bg-white/20 rounded-full blur-3xl opacity-50"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          <div className="relative z-10 p-10 sm:p-16 lg:p-20 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm font-bold uppercase tracking-[0.15em] text-orange-700">
                Take The Next Step
              </span>
            </div>

            {/* Headline color restored to clean White */}
            <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight mb-6 animate-zoom-pulse drop-shadow-sm">
              Ready to open the door to your new home?
            </h2>

            {/* Description text color restored to White */}
            <p className="text-lg text-white leading-relaxed mb-10 max-w-lg font-light">
              Our dedicated Mortgage Specialists are on standby to guide you
              through our premium developer portfolio and tailor a financing
              plan that perfectly fits your lifestyle.
            </p>
          ...
          <div className="relative h-64 sm:h-80 lg:h-full min-h-[400px] w-full hidden sm:block overflow-hidden">
            ...
            />
            {/* Gradient overlay to blend cleanly into the green background on the left */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#b5d334] via-[#b5d334]/50 to-transparent"></div>
          </div>
        </div>
      </div>
    </section>
