...
const slides = [
  {
    ...
    subtitle:
      "Access Bank provides the exclusive financial pathways and tailored mortgage solutions you need to acquire Ghana's most prestigious properties.",
    image: "/assets/access.jpg",
    ctaText: "Contact Us",
    ctaLink: "/contact",
    btnColor: "bg-[#b5d334] hover:bg-[#b5d334]/90 text-white",
  },
  {
    id: 2,
    title: "Devtraco Plus",
    subtitle:
      "Experience signature luxury and award-winning developments crafted for the modern visionary. Discover a new standard of living.",
  ...
  },
  {
    ...
    title: "Quao Realties",
    subtitle:
      "Redefining urban elegance. Invest in architectural masterpieces that stand the test of time in prime locations.",
  ...
  },
  {
    ...
    title: "Mac Capital",
    subtitle:
      "Invest in unparalleled craftsmanship and high-yield residential havens designed for maximum comfort and return.",
  ...
  },
  {
    ...
    subtitle:
      "Discover bespoke living spaces where cutting-edge innovation meets everyday comfort and tranquility.",
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            {/* Overlays */}
            <div
              className={`absolute inset-0 ${index === 0 ? "bg-blue-900/60" : "bg-black/50"}`}
            ></div>
          ...
          <div className="relative z-20 h-full max-w-6xl mx-auto px-6 lg:px-8 flex flex-col justify-center">
            ...
            >
              ...
              <Link
                href={slide.ctaLink}
                className={`inline-block px-10 py-4 rounded-full font-bold tracking-wide shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300 ${slide.btnColor}`}
              >
                {slide.ctaText}
              </Link>
            </div>
