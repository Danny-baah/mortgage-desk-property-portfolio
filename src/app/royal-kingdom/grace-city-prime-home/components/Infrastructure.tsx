    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <p className="text-stone-600 font-medium text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
          Experience a master-planned community engineered for modern living and long-term value. Grace City Prime Homes features highly curated infrastructure, including well-graded road networks, reliable electrification, and advanced drainage systems, ensuring your investment rests on a flawless foundation.
        </p>
      </div>
      ...
      <div className="w-full relative bg-stone-50">
        <img
          src="/assets/grace_city_prime_homes/Picture28.jpg"
