...
export default function ContactAccessBankPage() {
  ...
  return (
    <main className="bg-white min-h-screen flex flex-col">
      ...
      {/* =========================================================
         1. CLEAN HERO SECTION WITH FLOATING ACCESS CARD
         ========================================================= */}
      <section className="relative w-full min-h-[500px] lg:min-h-[580px] flex items-center bg-blue-950 overflow-visible z-10">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-950 via-blue-950/85 to-blue-900/50"></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              ...
              <p className="text-blue-100/80 text-base md:text-lg font-light leading-relaxed max-w-lg">
                Connect directly with our specialized mortgage desk advisors to review flexible financing frameworks tailored completely around your global acquisition goals.
              </p>
            </div>
                ...
                <div className="flex flex-col h-full space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed font-light">
                      Secure pre-approvals, competitive international currency frameworks, and structured long-term financial backing under one consolidated banking umbrella.
                    </p>
                  </div>
                  ...
                  <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-blue-900 uppercase tracking-wider">Access Bank</span>
                    </div>
            ...
            <div className="lg:col-span-5 flex flex-col space-y-8">
              <div>
                ...
                <p className="text-slate-600 font-light leading-relaxed">
                  Our professional Mortgage Desk specialists are deployed globally to support both domestic accounts and international diaspora property acquisitions.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-200">
                ...
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-900 flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <h4 className="font-bold text-blue-950 text-sm mb-0.5">Access Bank Head Office</h4>
                    <p className="text-xs text-slate-500 leading-relaxed">Starlets' 91 Street, Opposite Ohene Djan Stadium, Accra, Ghana</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <div>
                      <h4 className="font-bold text-blue-950 text-xs mb-0.5">Direct Lines</h4>
                      <p className="text-[11px] text-slate-600 font-medium leading-tight">+233 302 742699<br/>+233 540 102702</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                    <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-blue-900 flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-bold text-blue-950 text-xs mb-0.5">Email Support</h4>
                      <p className="text-[11px] text-blue-800 font-bold truncate">mortgages@<br/>accessbankplc.com</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-7 bg-white rounded-[24px] p-8 md:p-10 shadow-xl border border-slate-100 relative">
              {submitted && (
                <div className="absolute inset-0 bg-blue-950/95 rounded-[24px] flex flex-col items-center justify-center text-center z-20 p-6">
                  ...
                  <p className="text-slate-300 text-sm font-light max-w-xs">An Access Bank representative has logged your requirements and will follow up shortly.</p>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-blue-950 uppercase tracking-wider mb-1.5">Phone</label>
                  ...
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-blue-950 uppercase tracking-wider mb-1.5">Email</label>
                ...
                <div className="flex flex-col">
                  <label className="text-[11px] font-bold text-blue-950 uppercase tracking-wider mb-1.5">Message / Financing Requirements</label>
                  <textarea rows={4} placeholder="Type your inquiry or dynamic asset specifications here..." className="w-full bg-slate-50 border border-slate-200/70 rounded-xl px-4 py-3 text-slate-800 text-sm focus:outline-none focus:border-blue-900 focus:bg-white transition-colors resize-none" required></textarea>
                </div>

                <button type="submit" className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3.5 bg-blue-900 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all duration-300 hover:bg-orange-500 shadow-md cursor-pointer">
                  Submit Request
                </button>
              </form>
            </div>
      ...
      {/* =========================================================
         3. SIMPLIFIED REGISTRATION SECTION (With Faceless Image)
         ========================================================= */}
          ...
          <div className="bg-slate-50 rounded-[32px] border border-slate-100 overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 p-8 md:p-12 lg:p-16 flex flex-col items-start text-left">
              ...
              <p className="text-slate-600 font-light text-base mb-8 max-w-xl">
                Skip generic entry channels and pre-qualify your financial portfolio instantly by integrating directly within our dedicated client registry.
              </p>
