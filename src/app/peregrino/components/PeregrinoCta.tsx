...
export default function CTA() {
  return (
    <section className="pt-0 pb-6 lg:pb-12 bg-white relative px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          <div className="relative z-10 p-10 sm:p-16 lg:p-20 flex flex-col justify-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight mb-6 animate-zoom-pulse drop-shadow-md">
              Interested in purchasing a Peregrino property?
            </h2>
            ...
            {/* BUTTONS: Register Interest & Contact Side-by-Side */}
            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
              {/* PRIMARY ACTION: Register */}
              <Link 
                href="/register" 
                className="group inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-300 bg-orange-500 rounded-full hover:bg-orange-600 shadow-lg hover:shadow-orange-500/30 hover:-translate-y-1 text-center"
              >
                Register Interest
                <svg 
              ...
              {/* SECONDARY ACTION: Contact Team */}
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-blue-100 transition-all duration-300 border border-blue-700/60 rounded-full hover:bg-blue-800 hover:text-white text-center"
              >
                Contact Our Team
              </Link>
            </div>
