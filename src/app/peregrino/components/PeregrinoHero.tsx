      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start pt-10 lg:pt-0 order-2 lg:order-1">
            ...
            <h1 className="animate-slide-right-2 text-5xl md:text-7xl lg:text-[5rem] font-black text-blue-950 leading-[1.05] tracking-tighter mb-8">
              Peregrino <br />
            ...
            <p className="animate-slide-right-3 text-xl md:text-2xl text-slate-600 font-light leading-relaxed mb-10 border-l-4 border-slate-200 pl-6">
              Modern living. <br />
              Prime locations. <br />
              <span className="font-semibold text-blue-900">Smart investments.</span>
            </p>

            <div className="animate-slide-right-3 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link
                href="/register"
                className="inline-flex items-center justify-center px-8 py-4 bg-blue-950 text-white rounded-xl font-bold transition-all duration-300 hover:bg-orange-500 shadow-xl hover:shadow-orange-500/30 hover:-translate-y-1 group"
              >
                Register Interest
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-blue-950 border border-slate-200 rounded-xl font-bold transition-all duration-300 hover:border-blue-900 hover:bg-slate-50"
              >
          ...
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end order-1 lg:order-2 animate-slide-left">
            ...
            <div className="animate-float absolute bottom-10 -left-6 md:-left-12 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-2xl border border-white/50 max-w-[220px]">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider">High Yield</span>
              </div>
