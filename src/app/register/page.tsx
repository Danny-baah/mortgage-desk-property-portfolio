...
export default function RegisterAcquisitionPage() {
  ...
  const propertyDatabase: Record<string, string[]> = {
    ...
    quao_realty: ["The Autograph", "The Manora"],
    atta_doku_meadows: ["Nile", "The Densu", "The Pacific"],
  };
      ...
      <section className="relative w-full min-h-[500px] lg:min-h-[580px] flex items-center bg-black-950 overflow-visible z-10">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Left Column: Direct Heading styled with Dominant Brand Color */}
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#b5d334] leading-tight tracking-tight mb-6">
                Formalize Your <br />
                Acquisition <br />
                Registry Profile.
              </h1>
              <p className="text-blue-100/80 text-base md:text-lg font-light leading-relaxed max-w-lg">
                Submit your primary credentials directly to secure verified
                routing, prioritize structural review, and fast-track
                institutional backing across our accredited developer landscape.
              </p>
            </div>
                ...
                <div className="flex flex-col h-full space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed font-light">
                      This centralized clearance infrastructure ensures direct
                      alignment with premium banking frameworks, offering
                      bespoke protection parameters for all onboarding buyers.
                    </p>
                  </div>
                  ...
                  <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      {/* Dominant Color for Access Bank Finance */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col space-y-6 lg:sticky lg:top-28">
              <div>
                {/* Account Onboarding changed to text-orange-500 */}
                <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-orange-500 mb-3">
                  Account Onboarding
                </h2>
                {/* Provide Your Credentials changed to dominant brand color */}
                <h3 className="text-3xl font-black text-[#b5d334] tracking-tight leading-tight mb-4">
                  Provide Your Credentials
                </h3>
                <p className="text-slate-600 font-light text-sm leading-relaxed">
                  Please complete the framework details. All verification data
                  undergoes strict institutional processing via encrypted
                  protocols to guarantee comprehensive comprehensive compliance.
                </p>
              </div>
              ...
              <div className="p-5 bg-white border border-slate-100 rounded-2xl shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-blue-950 mb-0.5">
                    Identity Verification Required
                  </h4>
                  <p className="text-[11px] text-slate-500 leading-normal">
                    A clear structural scan of your valid national
                    identification card (Ghana Card) is essential to establish
                    authorized purchasing clearance.
                  </p>
                </div>
              </div>
            </div>
              ...
              {submitted && (
                <div className="absolute inset-0 bg-blue-950/95 rounded-[24px] flex flex-col items-center justify-center text-center z-20 p-6">
                  ...
                  <h4 className="text-2xl font-black text-white mb-2">
                    Registry Application Tracked
                  </h4>
                  <p className="text-slate-300 text-sm font-light max-w-sm leading-relaxed">
                    Thank you, your pre-qualification document portfolio has
                    been officially updated inside the institutional database
                    registry system.
                  </p>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-blue-950 uppercase tracking-wider mb-1.5">
                      First name
                    </label>
                    <input
                      type="text"
                      placeholder="Daniel"
                      className="w-full bg-slate-50 border border-slate-200/70 rounded-xl px-4 py-3 text-slate-800 text-sm focus:outline-none focus:border-blue-950 focus:bg-white transition-colors"
                      required
                    />
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <label className="w-full flex items-center justify-between bg-slate-50 border border-slate-200/70 rounded-xl px-4 py-3 text-sm cursor-pointer hover:border-slate-300 transition-colors">
                      <span
                        className={
                          fileName
                            ? "text-slate-800 font-medium truncate max-w-[180px]"
                            : "text-slate-400"
                        }
                      >
                        {fileName || "Select ID document scan..."}
                      </span>
                      {/* Changed button to bg-blue-950 */}
                      <span className="text-xs bg-blue-950 text-white font-bold px-3 py-1 rounded-lg flex-shrink-0">
                        Browse
                      </span>
                      <input
                        type="file"
                  ...
                  <div className="flex flex-col">
                    ...
                    <select
                      className="w-full bg-slate-50 border border-slate-200/70 rounded-xl px-4 py-3.5 text-slate-800 text-sm focus:outline-none focus:border-blue-950 focus:bg-white transition-colors appearance-none cursor-pointer"
                      required
                      defaultValue=""
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
                  <div className="flex flex-col">
                    ...
                    >
                      ...
                      <option value="atta_doku_meadows">
                        Atta Doku Meadows
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-blue-950 uppercase tracking-wider mb-1.5">
                      Select Target Residence / Project
                    </label>
                    {propertyDatabase[selectedDeveloper] ? (
                      <select
                        className="w-full bg-slate-50 border border-blue-950 rounded-xl px-4 py-3.5 text-slate-800 text-sm focus:outline-none appearance-none cursor-pointer animate-fade-in"
                        required
                        defaultValue=""
                      >
                        <option value="" disabled>
                          Select specific project option...
                        </option>
                        {propertyDatabase[selectedDeveloper].map(
                          (residence) => (
                            <option
                              key={residence}
                              value={residence.toLowerCase().replace(/ /g, "_")}
                            >
                              {residence}
                            </option>
                          ),
                ...
                <div className="flex flex-col">
                  ...
                  <textarea
                    rows={4}
                    placeholder="Type any specific framework preferences or credit structuring queries..."
                    className="w-full bg-slate-50 border border-slate-200/70 rounded-xl px-4 py-3 text-slate-800 text-sm focus:outline-none focus:border-blue-950 focus:bg-white transition-colors resize-none"
                    required
                  ></textarea>
                </div>

                {/* Changed submit button to bg-blue-950 */}
                <button
                  type="submit"
                  className="w-full md:w-auto inline-flex items-center justify-center px-10 py-4 bg-blue-950 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all duration-300 hover:bg-orange-500 shadow-md cursor-pointer"
                >
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-50 rounded-[32px] border border-slate-100 overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12 items-center">
            ...
            {/* Right Hand Column: Copy details with Dominant Brand Color heading */}
            <div className="lg:col-span-7 p-8 md:p-12 lg:p-16 flex flex-col items-start text-left">
              ...
              <p className="text-slate-600 font-light text-base mb-8 max-w-xl">
                If you have nuanced structural criteria or need dedicated
                assistance from an individual Mortgage Consultant before
                registry formalization, access our priority communication desk.
              </p>

              {/* Changed link button layout to bg-blue-950 */}
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-blue-950 text-white rounded-xl font-bold text-sm shadow-lg hover:bg-orange-500 transition-all duration-300 group"
              >
                Go to Contact Page
                <svg
