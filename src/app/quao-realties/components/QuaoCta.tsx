...
export default function CTA() {
  return (
    // REDUCED pt-20 lg:pt-32 down to pt-8 lg:pt-12 to remove the massive gap
    <section className="pt-8 lg:pt-12 pb-12 lg:pb-24 bg-white relative px-4 sm:px-6 lg:px-8 overflow-hidden">
