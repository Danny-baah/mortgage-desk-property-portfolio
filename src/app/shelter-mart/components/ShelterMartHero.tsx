...
export default function ShelterMartHero() {
  return (
    <section className="relative w-full h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      <style
        ...
        /* Continuous Zoom In and Out for the Heading */
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/shelter/Picture2.jpeg"
          alt="Shelter Mart Properties Portfolio"
          fill
          priority
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center mt-16">
        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 md:p-12 lg:p-16 rounded-3xl shadow-2xl text-center max-w-4xl w-full">
          <div className="animate-fade-up-1 flex items-center justify-center gap-4 mb-6">
            ...
            <span className="text-sm font-bold uppercase tracking-[0.3em] text-orange-500 drop-shadow-md">
          ...
          <div className="animate-fade-up-2 mb-6">
            <h1 className="animate-pulse-scale text-4xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight drop-shadow-lg">
              <span className="text-[#b5d334]">SHELTER MART</span> <br />
          ...
          <p className="animate-fade-up-3 text-lg md:text-xl text-gray-200 font-light leading-relaxed max-w-2xl mx-auto mb-10 drop-shadow-sm">
            A wholly-owned Ghanaian company bringing ultimate professionalism
            and sanity to property rentals, management, and real estate services
            for both premium residential and commercial spaces.
          </p>
          ...
          <div className="animate-fade-up-4">
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center px-8 py-4 bg-[#b5d334] text-neutral-900 rounded-full font-bold text-base transition-all duration-300 hover:bg-white hover:text-black shadow-xl hover:-translate-y-1"
            >
              Contact Us to View
              <svg
